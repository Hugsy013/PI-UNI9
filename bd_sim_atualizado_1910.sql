...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/10/2024 às 21:48
...
--
ALTER TABLE `tb_admin`
  MODIFY `idAdmin` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK do admin';
...
--
ALTER TABLE `tb_pf`
  MODIFY `idPf` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK do pf', AUTO_INCREMENT=8;
