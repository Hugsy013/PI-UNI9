...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20/11/2024 às 04:57
...
(10, '503.868.078-09', 'Beatriz Alves', '53.146.888-4', '0000-00-00', 'bia.h.alves2001@uni9.edu.br', '11912345678', 3, 'ABC1D23', 'Preto', 'Rua Exemplo, 123'),
(11, '511.220.018-84', 'Matheus Lucas Gomes', '39.179.740-4', '2024-10-25', 'teste@teste.com', '11946044074', 4, 'DJU7H25', 'Preto', 'Rua Carlos Beumiro Correira, 644 - 02532-012');
...
--
ALTER TABLE `tb_pf`
  MODIFY `idPf` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK do pf', AUTO_INCREMENT=13;
