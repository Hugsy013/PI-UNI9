...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/11/2024 às 01:55
...
(10, '123.456.789-10', 'Beatriz', '12.345.678-9', '2001-08-30', 'teste@teste', '11912345678', 3, 'ABC1D23', 'Preto', 'Rua Exemplo, 123');
...
--
ALTER TABLE `tb_pf`
  MODIFY `idPf` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK do pf', AUTO_INCREMENT=11;
